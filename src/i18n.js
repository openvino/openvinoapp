  ...
  resources: {
    en: {
      translations: {
        ...
        "Minting is currently available only on ETH Mainnet. Check your Network on Metamask": "Minting is currently available only on Polygon testnet (Mumbai). Check your Network on your wallet",
    ...
    es: {
      translations: {
        ...
        "Minting is currently available only on ETH Mainnet. Check your Network on Metamask": "El minting está actualmente disponible sólo en la red test de Polygon. Compruebe su red en su wallet",
